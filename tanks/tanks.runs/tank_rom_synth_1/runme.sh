...
HD_PWD='C:/aherce2/ECE-385---Final-Project/tanks/tanks.runs/tank_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tank_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tank_rom.tcl
