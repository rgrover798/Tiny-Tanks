...
HD_PWD='C:/aherce2/ECE-385---Final-Project/tanks/tanks.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tanks_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tanks_top_level.tcl
