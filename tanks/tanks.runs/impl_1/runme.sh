...
HD_PWD='C:/aherce2/ECE-385---Final-Project/tanks/tanks.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tanks_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tanks_top_level.tcl -notrace
