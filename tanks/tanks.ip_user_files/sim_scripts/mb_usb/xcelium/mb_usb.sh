...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../tanks.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../tanks.gen/sources_1/bd/mb_usb/ipshared/7698" \
       +incdir+"../../../../tanks.gen/sources_1/bd/mb_usb/ipshared/ec67/hdl" \
       +incdir+"../../../../tanks.gen/sources_1/bd/mb_usb/ipshared/7698" \
       +incdir+"../../../../tanks.gen/sources_1/bd/mb_usb/ip/mb_usb_hdmi_text_controller_0_0/src/clk_wiz_0" \
       -input simulate.do
}
